...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Mombasa Kiongozi Academy — Mombasa, Kenya" },
      { property: "og:description", content: "A modern academy in Mombasa, Kenya shaping tomorrow's leaders." },
